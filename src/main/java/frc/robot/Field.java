...
public interface Field {
    ...
    AprilTag APRILTAGS[] = {
        ...
        new AprilTag(18,  new Pose3d(new Translation3d(Units.inchesToMeters(144.0 - 13.5), Units.inchesToMeters(158.50), Units.inchesToMeters(12.13)), new Rotation3d(Units.degreesToRadians(0), Units.degreesToRadians(0), Units.degreesToRadians(180)))),
