...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        /*
         * buttonBoxController.enterTrigger().onTrue(elevator.goToElevatorStow());
         * buttonBoxController.mapTrigger().onTrue(elevator.goToElevatorL2());
         * buttonBoxController.audioTrigger().onTrue(elevator.goToElevatorL3());
         * buttonBoxController.cruiseTrigger().onTrue(elevator.goToElevatorL4());
         * 
         * driveController.leftTrigger().whileTrue(new ScoreCoral(
         * new Pose2d(0, new PARTsUnit(-2, PARTsUnitType.Inch).to(PARTsUnitType.Meter),
         * new Rotation2d()),
         ...
         * drivetrain, elevator, coral, candle));
         * 
         * buttonBoxController.wipeTrigger().onTrue(coral.intake());
         * operatorController.rightBumper().onTrue(coral.reverse());
         * operatorController.leftTrigger().onTrue(coral.stopCoral());
         * buttonBoxController.escTrigger().onTrue(coral.scoreCommand());
         * 
         */
        ...
        buttonBoxController.nukeTrigger().toggleOnTrue(Commands.runOnce(() -> {
            elevatorManualControl = !elevatorManualControl;
        }));
        
            buttonBoxController.escTrigger().whileTrue(Commands.runOnce(() -> {
            ...
            buttonBoxController.escTrigger().whileTrue(Commands.runOnce(() -> {
                if (elevatorManualControl) 
                    elevator.goToElevatorStow();
                     ...
                     new ScoreCoral(
                new Pose2d(0, new PARTsUnit(-2, PARTsUnitType.Inch).to(PARTsUnitType.Meter),
                        new Rotation2d()), ElevatorState., drivetrain, elevator, coral, candle);
            }));
            buttonBoxController.escTrigger().whileTrue(Commands.runOnce(() -> {
                if (elevatorManualControl) 
                    elevator.goToElevatorStow();
            ...
            buttonBoxController.mapTrigger().whileTrue(elevator.goToElevatorL2());

            buttonBoxController.audioTrigger().whileTrue(elevator.goToElevatorL3());

            buttonBoxController.cruiseTrigger().whileTrue(elevator.goToElevatorL4());
        }
        else {
        buttonBoxController.escTrigger().whileTrue(new ScoreCoral(
                new Pose2d(0, new PARTsUnit(-2, PARTsUnitType.Inch).to(PARTsUnitType.Meter),
                        new Rotation2d()),
                ElevatorState.STOW,
                drivetrain, elevator, coral, candle));
        ...
        buttonBoxController.mapTrigger().whileTrue(new ScoreCoral(
                new Pose2d(0, new PARTsUnit(-2, PARTsUnitType.Inch).to(PARTsUnitType.Meter),
                        new Rotation2d()),
                ElevatorState.L2,
                drivetrain, elevator, coral, candle));

        buttonBoxController.audioTrigger().whileTrue(new ScoreCoral(
                new Pose2d(0, new PARTsUnit(-2, PARTsUnitType.Inch).to(PARTsUnitType.Meter),
                        new Rotation2d()),
                ElevatorState.L3,
                drivetrain, elevator, coral, candle));
        ...
        buttonBoxController.wipeTrigger().whileTrue(new ScoreCoral(
                new Pose2d(0, new PARTsUnit(-2, PARTsUnitType.Inch).to(PARTsUnitType.Meter),
                        new Rotation2d()),
                ElevatorState.L2,
                drivetrain, elevator, coral, candle));

        buttonBoxController.flashTrigger().whileTrue(new ScoreCoral(
                new Pose2d(0, new PARTsUnit(-2, PARTsUnitType.Inch).to(PARTsUnitType.Meter),
                        new Rotation2d()),
                ElevatorState.L3,
                drivetrain, elevator, coral, candle));
        buttonBoxController.handleTrigger().whileTrue(new ScoreCoral(
                new Pose2d(0, new PARTsUnit(-2, PARTsUnitType.Inch).to(PARTsUnitType.Meter),
                        new Rotation2d()),
                ElevatorState.L4,
                drivetrain, elevator, coral, candle));
