...
public class AutoAlignCoralStop extends SequentialCommandGroup {

        /** Creates a new ScoreCoral. */
        public AutoAlignCoralStop(Pose2d holdDistance, ElevatorState level, PARTsDrivetrain drivetrain, Elevator elevator,
